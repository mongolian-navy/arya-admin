...
DefinitionsCreateapp = {'type': 'object', 'properties': {'namespace': DefinitionsNamespace}}
DefinitionsOperateengine = {'type': 'object', 'properties': {'operate': {'enum': ['start', 'stop', 'restart'], 'type': 'string'}, 'app_ids': {'items': DefinitionsId, 'type': 'array'}}}
...
DefinitionsApp = {'type': 'object', 'properties': {'routes': {'items': DefinitionsRoute, 'type': 'array'}, 'namespace': DefinitionsNamespace, 'id': DefinitionsId}}
DefinitionsEngine = {'type': 'object', 'properties': {'status': {'enum': ['active', 'inactive'], 'type': 'string'}, 'report': {'type': 'string', 'description': 'report in json format (return by engine)'}, 'message': {'type': 'string', 'description': 'status detail'}, 'apps': {'items': DefinitionsApp, 'type': 'array', 'description': 'active apps (return by engine)'}}}

validators = {
    ('apps_app_id', 'GET'): {'args': {'required': [], 'properties': {'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 10000}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer'}}}},
    ('apps', 'POST'): {'json': DefinitionsCreateapp},
    ('apps', 'GET'): {'args': {'required': [], 'properties': {'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 10000}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer'}}}},
    ('engine', 'PUT'): {'json': DefinitionsOperateengine},
    ('apps_app_id_routes', 'POST'): {'json': DefinitionsCreateroute},
    ('apps_app_id_routes', 'GET'): {'args': {'required': [], 'properties': {'per_page': {'description': 'per_page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'limit': {'description': 'limit number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 100}, 'page': {'description': 'page number', 'format': 'int32', 'required': False, 'type': 'integer', 'maximum': 10000}, 'offset': {'description': 'offset number', 'format': 'int32', 'required': False, 'type': 'integer'}}}},
}

filters = {
    ('apps_app_id_routes_route_id', 'GET'): {200: {'headers': None, 'schema': DefinitionsRoute}},
    ('apps_app_id', 'GET'): {200: {'headers': None, 'schema': DefinitionsApp}},
    ('apps', 'POST'): {201: {'headers': None, 'schema': DefinitionsApp}},
    ('apps', 'GET'): {200: {'headers': None, 'schema': {'items': DefinitionsApp, 'type': 'array'}}},
    ('engine', 'PUT'): {200: {'headers': None, 'schema': DefinitionsEngine}},
    ('engine', 'GET'): {200: {'headers': None, 'schema': DefinitionsEngine}},
    ('apps_app_id_routes', 'POST'): {201: {'headers': None, 'schema': DefinitionsRoute}},
    ('apps_app_id_routes', 'GET'): {200: {'headers': None, 'schema': {'items': DefinitionsRoute, 'type': 'array'}}},
}
